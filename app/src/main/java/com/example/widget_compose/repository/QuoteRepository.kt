...
class QuoteRepository {
    ...
    private val quoteList = listOf(
        ...
        "Stop making C+ decision while praying for an A+ life.",
        ...
        "Teh story is not in the words; it;s in the struggle. ― Paul Auster",
        ...
        "Some people feel the rain, others just het wet. ― Bob Marley",
        ...
        "Instead of thinking how hard your journey is, think how great you story will be...",
        "There is no change where there is no action.",
        "Discipline is rarely enjoyable, but almost always profitable.",
        "One of the key to moving ahead is knowing what to leave behind.",
        ...
        "You've never ready fir what you have to do. You just do it. That makes you ready.",
        ...
        "Never beg for seat when you can build your own table.",
        "You move different when you know your power.",
        ...
        "Pay the price today so that you can oay any price tomorrow.",
        "Don't ket your bad days trick you into thinking you have a bad life.",
